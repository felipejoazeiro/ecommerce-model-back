...
if(process.env.NODE_ENV !== "production"){    
    router.get('token', (req,res)=> res.render('pagseguro/index'))
} 
...
router.post('/pagar/:id', auth.required, Validation(PagamentoValidation.pagar), pagamentoController.pagamento)
