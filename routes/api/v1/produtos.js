...
router.put("/images/:id", auth.required, LojaValidation.admin, Validation(ProdutoValidation.updateImages), upload.array("files", 4), produtoController.updateImage);
...
//AVALIACOES
router.get('/:id/produtos', Validation(ProdutoValidation.showAvaliacoes), produtoController.showAvaliacoes)
